...
// D1.2. Add a 2nd layer group for the tectonic plate data.
...
d3.json(earthquakeData).then(function (data) {
  ...
  legend.onAdd = function() {
    ...
    legend.addTo(map);
  // link to tectonic pletes raw data
  d3.json("https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json").then(function(tectonicData) {
    ...
    // pass to geoJSON() layer
    L.geoJSON(tectonicData, {
      color: "orange",
      wieght: 2.5,
    }).addTo(tectonicPlates);

    // add the tectonic layer group varaible to the map
